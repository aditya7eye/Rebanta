...
@section('content')
@php
    $branchcount = \App\Branch::where(['is_del' => 0 , 'c_id' => session('clientmaster')->id])->count();
@endphp
    ...
    <div class="row">
        <div class="col-lg-12">
            <div class="text-center m-t-lg">
                <h1>
                    Welcome in <b>Rebanta</b> Client Access.
                </h1>
                {{-- <small>
            ...
            <div class="col-md-3">
                <div class="dash-box dash-box-color-1">
                    ...
                    <div class="dash-box-body">
                        <span class="dash-box-count">{{ $branchcount }}</span>
